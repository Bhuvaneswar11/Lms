	...
	<header class="masthead bg-primary text-white text-center">
		<div class="container d-flex align-items-center flex-column">
			<img class="masthead-avatar mb-5" src="assets/img/avataaars.svg"
				alt="..." />
			<h1 class="masthead-heading text-uppercase mb-0">Welcome To Tech Beast</h1>
        ...
        <div class="flip-box-inner">
          ...
          <div class="flip-box-back">
            <p><ol>Here it is freelancing Website </ol></p>
          </div>
        </div>
      </div>
		...
		<div class="container">
			...
			<div class="divider-custom divider-light">
				...
				<div class="divider-custom-line"></div>
			      ...
			      <iframe width="238" height="150" src="https://www.youtube.com/embed/VIDEO_IDhttps://www.youtube.com/watch?v=YT3qN6n6EgY&list=PLuqUq6yfXlCFij5xf8rFFWfPKobLNAPbs" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
